...
var personalize_createDataDeletionJobCmd = &cobra.Command{
	Use:   "create-data-deletion-job",
	Short: "Creates a batch job that deletes all references to specific users from an Amazon Personalize dataset group in batches.",
