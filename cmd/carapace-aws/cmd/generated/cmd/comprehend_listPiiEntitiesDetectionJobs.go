...
var comprehend_listPiiEntitiesDetectionJobsCmd = &cobra.Command{
	Use:   "list-pii-entities-detection-jobs",
	Short: "Gets a list of the PII entity detection jobs that you have submitted.",
