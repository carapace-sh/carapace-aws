...
func CamelCaseToDash(s string) string {
	...
	quickfix := map[string]string{
		...
		"checksum-cr-c32-c":                                  "checksum-crc32-c",
		"checksum-cr-c32":                                    "checksum-crc32",
		"checksum-cr-c64-nvme":                               "checksum-crc64-nvme",
		"checksum-m-d5":                                      "checksum-md5",
		"checksum-sh-a1":                                     "checksum-sha1",
		...
		"deprecate-whats-app-flow":                           "deprecate-whatsapp-flow",
		...
		"describe-storedi-scsi-volumes":                      "describe-stored-iscsi-volumes",
		"disable-imds-v1":                                    "disable-imdsv1",
		...
		"get-whats-app-flow":                                 "get-whatsapp-flow",
		"get-whats-app-flow-preview":                         "get-whatsapp-flow-preview",
		"get-whats-app-message-media":                        "get-whatsapp-message-media",
		"get-whats-app-message-template":                     "get-whatsapp-message-template",
		"introspect-o-auth2-token-with-iam":                  "introspect-oauth2-token-with-iam",
		...
		"list-whats-app-flow-assets":                         "list-whatsapp-flow-assets",
		"list-whats-app-flows":                               "list-whatsapp-flows",
		...
		"no-disable-imds-v1":                                 "no-disable-imdsv1",
		...
		"publish-whats-app-flow":                             "publish-whatsapp-flow",
		...
		"update-whats-app-flow":                              "update-whatsapp-flow",
		"update-whats-app-flow-assets":                       "update-whatsapp-flow-assets",
